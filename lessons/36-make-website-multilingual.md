  ...
  settings: [
    {
      ...
      site: {
        name: 'GOLDYY SUPPLEMENTS',
        description:
          'GOLDYY SUPPLEMENTS is a sample Ecommerce website built with Next.js, Tailwind CSS, and MongoDB.',
        keywords: 'GOLDYY SUPPLEMENTS',
        url: 'https://next-mongo-ecommerce-final.vercel.app',
        logo: '/icons/logo.svg',
        slogan: 'Spend less, enjoy more.',
        author: 'GOLDYY SUPPLEMENTS',
        copyright: '2000-2024, purchasey.in, Inc. or its affiliates',
        email: 'GOLDYY SUPPLEMENTS.com',
        address: '107,egnight zym, gurufate town, CA, Zip 140301',
...
-export const APP_NAME = process.env.NEXT_PUBLIC_APP_NAME || 'GOLDYY SUPPLEMENTS'
